...
from api.notifications import create_notification_for_members
...
def create_project():
    ...
    try:
        ...
        notification = Notification(
            ...
            content=f'You created project "{project.name}"',
...
def get_my_projects():
    ...
    try:
        ...
        for project, total_tasks, completed_tasks, member_count in all_projects.items:
            ...
            progress = round((completed_count / task_count) * 100) if task_count > 0 else 0
            ...
            projects_list.append({
                ...
                'owner': {
                    ...
                    'avatar_url': project.owner.avatar_url or f"https://ui-avatars.com/api/?name={project.owner.username}&background=random"
                },
                'my_role': my_role,
...
def update_project(project_id):
    ...
    try:
        ...
        create_notification_for_members(
            ...
            content=f'{current_user.username} updated "{project.name}"',
            exclude_user_id=current_user.id,
            include_self=True  # 操作者也收到確認通知
        )
...
def get_project_members(project_id):
    ...
    try:
        ...
        members_list.append({
            ...
            'name': owner.username,
            'email': owner.email,
            'avatar_url': owner.avatar_url or f"https://ui-avatars.com/api/?name={owner.username}&background=random",
        ...
        for m in members:
            if m.user.id != owner.id:
                members_list.append({
                    ...
                    'email': m.user.email,
                    'avatar_url': m.user.avatar_url or f"https://ui-avatars.com/api/?name={m.user.username}&background=random",
